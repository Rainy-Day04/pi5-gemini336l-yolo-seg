            ...
            Node(
                ...
                parameters=[
                    LaunchConfiguration("config"),
                    {
                        ...
                        "max_depth_time_delta_sec": ParameterValue(
                            LaunchConfiguration("max_depth_time_delta_sec"),
                            value_type=float,
                        ),
                        "depth_candidate_frames": ParameterValue(
                            LaunchConfiguration("depth_candidate_frames"),
                            value_type=int,
                        ),
